...
page_about = Page.create(project_id: project.id, title: 'About QKspace', source: 'QKspace (pronounced "quick space")
  is a minimalistic knowledge base for small teams.')

page_description = Page.create(project_id: project.id, title: 'QKspace Project Description', source: 'It is perfect for creating
